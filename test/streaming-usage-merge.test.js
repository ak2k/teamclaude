...
// A stream can die after message_start. The prompt was still processed and
// billed, so the input side it reported must survive; there is simply no
// authoritative output figure to record.
