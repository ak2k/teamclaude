...
| `expiryRouting` | Optional [expiry-pressure routing](routing.md#expiry-pressure-routing) (off by default). Object: `{ enabled, tolerance, preempt }` — prefer accounts whose governing weekly quota is ample and resets soonest |
